...
<div class="min-h-screen bg-background">
	<div class="container mx-auto max-w-4xl px-4 pt-6 pb-12 sm:pt-8">
		<div class="mb-6">
		...
		{#if paginatedPosts.length === 0}
			<div class="py-16 text-center">
				...
				<p class="text-muted-foreground">
					{searchDebounced ? '未找到匹配的文章' : '暂无文章'}
				</p>
				<p class="mt-1 text-sm text-muted-foreground">
					{searchDebounced ? '尝试其他关键词' : '在 src/content/posts/ 目录下创建 Markdown 文件即可'}
				</p>
			</div>
		{:else}
